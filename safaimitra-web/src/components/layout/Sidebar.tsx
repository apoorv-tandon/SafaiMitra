...
export default function Sidebar({ isMobileMenuOpen, setIsMobileMenuOpen }: SidebarProps) {
  ...
  return (
    <>
      ...
      <Link to="/" className="flex items-center h-20 px-6 border-b border-gray-200 hover:bg-gray-50 transition-colors">
        <img src="/logo.png" alt="SafaiMitra Logo" className="h-14 w-14 object-contain rounded-full shadow-sm mr-3" />
